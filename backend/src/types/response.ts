...
export interface BrowseArticleRes {
  //single article
  article_id: string;
  title: string;
  author: {
...
export interface BrowseArticlesRes {
  //return several articles browsing
  articles: BrowseArticleRes[];
}

export interface getUsersArticlesRes {
  //return the articles published by specific author
  articles: {
    article_id: string;
    title: string;
    createdAt: string;
...
export interface CommentReplyRes {
...
export interface BrowseCommentRes {
  //first level comment
  _id: string;
  content: string;
  author: {
...
export interface ArticleDetailRes {
  //return signle detailed article
